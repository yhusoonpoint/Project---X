...
namespace Project___X
{
    public partial class meeting : Form
    {
        ...
        private void two_curve_edge_button4_Click(object sender, EventArgs e)
        {

        }

        private void arrow_head_picturebox4_Click(object sender, EventArgs e)
        {

        }

        private void two_curve_edge_button3_Click(object sender, EventArgs e)
        {

        }

        private void arrow_head_picturebox3_Click(object sender, EventArgs e)
        {
